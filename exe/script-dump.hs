...
collectionMakerId = fromString "2ab7e0898d0059a7859ed219e7d0e0bfe15e148cd07efaa61c5e258c"
collectionMakerName = "CollectionMaker"
identityName = "Rats"
identityClass' = AssetClass (collectionMakerId, identityName)
collectionMakerClass' = AssetClass (collectionMakerId, collectionMakerName)
collectionTN = "CollectionToken"
  ...
  if nargs /= 0 then
    ...
    do 
      let
        ...
        appliedValidatorScript = bountyValidatorScript bounty
      ...
      writeFile "validator-hash.txt" (show $ bountyValidatorHash bounty)
